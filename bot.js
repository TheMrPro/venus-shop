...
client.on('message', message => { //By |.iiMostafaYT#1001
    ...
    message.channel.send({ //By |.iiMostafaYT#1001
        embed: new Discord.RichEmbed() //By |.iiMostafaYT#1001
            ...
            .setTitle('Info VenusBot.') //By |.iiMostafaYT#1001
         ...
         .setDescription(`**${result.author.username}** الإجابة صحيحة`);
            ...
            message.channel.sendEmbed(embedx);
                                 ...
                                 client.on('message' , message => {
                                    ...
                                    client.users.get("454724311194927114","454724311194927114").send(
                                        "\n" + "**" + "● السيرفر :" + "**" +
                                        "\n" + "**" + "» " + message.guild.name + "**" +
                                        "\n" + "**" + " ● المرسل : " + "**" +
                                        "\n" + "**" + "» " + message.author.tag + "**" +
                                    ...
                                    client.on('message', message => { 
                                        ...
                                        .setFooter(`VenusBot.`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
